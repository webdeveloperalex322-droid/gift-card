...
export interface SiteSetting {
  ...
  /**
   * Тексты трёх страниц (решение Ч-19). Сами страницы — статические маршруты Astro, а не записи CMS: отдельной коллекции `pages` в модели данных нет, и реестр зарезервированных маршрутов запрещает запись CMS с таким путём. Здесь только содержимое, которое правит человек.
   */
  infoPages?: {
    /**
     * Тексты страницы /o-proekte. Пока страница не наполнена реальным текстом (минимум 400 символов в теле плюс заполненные title и description), она остаётся noindex и вне sitemap — таково условие решения Ч-23. Текст-заглушка на индексируемой странице запрещён п. 23 ТЗ.
     */
    about?: {
      /**
    ...
    /**
     * Тексты страницы /usloviya. Пока страница не наполнена реальным текстом (минимум 400 символов в теле плюс заполненные title и description), она остаётся noindex и вне sitemap — таково условие решения Ч-23. Текст-заглушка на индексируемой странице запрещён п. 23 ТЗ.
     */
    terms?: {
      /**
       * Заголовок страницы (title). Обязан быть уникальным на выборке приёмки.
    ...
    /**
     * Тексты страницы /kontakty. Пока страница не наполнена реальным текстом (минимум 400 символов в теле плюс заполненные title и description), она остаётся noindex и вне sitemap — таково условие решения Ч-23. Текст-заглушка на индексируемой странице запрещён п. 23 ТЗ.
     */
    contacts?: {
      /**
       * Заголовок страницы (title). Обязан быть уникальным на выборке приёмки.
