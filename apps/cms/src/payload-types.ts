...
export interface SiteSetting {
  ...
  imageLicense?: {
    /**
     * Кто создал изображение (свойство creator). Фиктивный автор запрещён п. 23 ТЗ: изображения генерирует нейросеть, и указание должно быть правдивым.
     */
    creator?: string | null;
    /**
  ...
  infoPages?: {
    ...
    about?: {
      ...
      metaDescription?: string | null;
      /**
       * Основной текст. Присутствует в HTML-ответе сервера — страница обязана быть полноценной при отключённом JS.
       */
      body?: {
        root: {
          type: string;
