...
export interface SiteSetting {
  ...
  /**
   * Лицензионные свойства ImageObject (решение Ч-10). Набор проверяется ЦЕЛИКОМ: пока не заполнены все значения набора (creator, creditText, copyrightNotice, license, acquireLicensePage, creatorKind), лицензионная часть разметки не выводится. Частично заполненная лицензия хуже отсутствующей — она выглядит юридически значимой, не будучи ею, а правится потом сразу на всём массиве опубликованных карточек.
   */
  imageLicense?: {
    /**
