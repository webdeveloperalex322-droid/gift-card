 ...
 * запроса приложению Astro: так работают и SSR-маршруты, и файловые маршруты
 * `robots.txt` и `sitemap*.xml` (задачи Э4-03, Э4-04) — файлов в `dist/client` у
 * них нет намеренно, их печатает приложение из данных и окружения РАНТАЙМА.
 *
