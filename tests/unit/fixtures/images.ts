 ...
 * за второе, порог похожести окажется заниженным — реальные дубли начнут
 * проходить проверку. Утверждённый порог 14 (Ч-08) выбран именно по замерам на
 * этих фикстурах, поэтому подмена образца «другой картинки» здесь меняла бы
 * норму проекта.
 *
